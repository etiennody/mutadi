...
#     def test_valid_live_change_password_page(self, proto_user):
#         """Validate data entries on the change password page"""
...
#             "/password_success",
#         )
#         assert "Mot de passe modifié :: Purbeurre" in self.driver.title
#         assert (
#             "Votre mot de passe a bien été modifié avec succès !"
#             in self.driver.page_source
#         )

#     def test_invalid_live_change_password_with_personal_information(
#         self, proto_user
#     ):
#         """Unvalidate data entries on the change password page with personal information"""
#         self.driver.get("%s%s" % (self.live_server_url, "/login/"))
...
#         password = self.driver.find_element(By.ID, "id_password")
#         submit = self.driver.find_element(By.ID, "submit-button")
#         username.send_keys(proto_user.username)
#         password.send_keys("m=9UaK^C,Tbq9N=T")
#         submit.send_keys(Keys.RETURN)
...
#         submit = self.driver.find_element(By.ID, "submit-button")
#         old_password.send_keys("m=9UaK^C,Tbq9N=T")
#         new_password1.send_keys(proto_user.username)
#         new_password2.send_keys(proto_user.username)
#         submit.send_keys(Keys.RETURN)
...
#         if (self.driver.current_url[len(self.driver.current_url) - 1]) == "/":
#             current_url = self.driver.current_url[:-1]
#         assert current_url == "%s%s" % (self.live_server_url, "/password")
#         assert (
#             "Le mot de passe est trop semblable "
#             "au champ «&nbsp;nom d’utilisateur&nbsp;»."
#         ) in self.driver.page_source

#     def test_invalid_live_change_password_with_only_number(self, proto_user):
#         """Unvalidate data entries on the change password page with only number"""
#         self.driver.get("%s%s" % (self.live_server_url, "/login/"))
#         username = self.driver.find_element(By.ID, "id_username")
#         password = self.driver.find_element(By.ID, "id_password")
...
#     def test_invalid_live_change_password_with_short_entries(self, proto_user):
#         """Unvalidate data entries on the change password page with short entries"""
#         self.driver.get("%s%s" % (self.live_server_url, "/login/"))
#         username = self.driver.find_element(By.ID, "id_username")
#         password = self.driver.find_element(By.ID, "id_password")
...
#     def test_invalid_live_change_password_with_differents_new_passwords(
#         self, proto_user
#     ):
#         """Unvalidate data entries on the change password page with short entries"""
#         self.driver.get("%s%s" % (self.live_server_url, "/login/"))
...
#     def test_invalid_live_change_password_with_wrong_old_password(
#         self, proto_user
#     ):
#         """Unvalidate data entries on the change password page with short entries"""
#         self.driver.get("%s%s" % (self.live_server_url, "/login/"))
